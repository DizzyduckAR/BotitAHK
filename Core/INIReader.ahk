...
GetCordsPixels()
{
	...
	OutputVar := IniGetKeys("Botit ini\ImageXY.ini", "Botit Pixel XY" , "|")
	global Botitini:=StrSplit(OutputVar,"|")
	Loop % Botitini.MaxIndex()
	{
		looper := % Botitini[A_Index]
