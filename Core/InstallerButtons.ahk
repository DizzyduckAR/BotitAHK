...
Buttoncaller(buttonname,tabname)
{
	...
	Gui, Submit, NoHide
	Clipboard :=
	IniRead,INItoDDLsplit,Botit ini\Installer.ini,Botit tab%tabname%,%buttonname%
...
ImageMaker:
{
	...
	INItoDDL2("menuChoice2","Botit ini\Installer.ini", "Botit tab"taber)
...
INItoDDL("menuChoice","Botit ini\ImageXY.ini", "Botit Pixel XY")
